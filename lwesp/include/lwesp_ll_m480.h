// Header: LWESP Low Level Nuvoton M480 Header File
// File Name: lwesp_ll_m480.h
// Author: Turgay Hopal
// Date: 29.11.2023

#ifndef INC_LWESP_LL_M480_H_
#define INC_LWESP_LL_M480_H_
